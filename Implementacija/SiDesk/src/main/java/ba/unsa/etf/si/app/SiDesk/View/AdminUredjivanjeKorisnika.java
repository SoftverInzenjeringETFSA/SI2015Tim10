		...
		btnSpasiIzmjene.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(!Validator.validirajIme(textField_ime.getText()) || !Validator.validirajPrezime(textField_prezime.getText()) ||
						...
						!Validator.validirajEmail(textField_email.getText()) || !Validator.validirajBrojLicneKarte(textField_brojLicne.getText())
				...
				ModifikacijaKorisnikaVM.modifikacijaKorisnika(listaKorisnika,textField_ime.getText(), textField_prezime.getText(), textField_jmbg.getText(),
						...
						textField_adresa.getText(), 
						 textField_brojLicne.getText(),
						d,comboBox_1.getSelectedItem().toString(),comboBox.getSelectedItem().toString());
				}
				}
		});
